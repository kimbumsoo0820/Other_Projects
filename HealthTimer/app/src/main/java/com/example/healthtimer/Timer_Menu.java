...
/*
public class Timer_Menu extends BasicActivity {
        ...
        FirebaseFirestore db = FirebaseFirestore.getInstance();
            ...
            menu_normal_timer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(Timer_Menu.this, Normal_Stopwatch.class);
            ...
            logout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    StartToast("로그아웃");
                    Intent intent = new Intent(Timer_Menu.this, Add_event_main.class);
                    startActivity(intent);
            ...
            menu_add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    FirebaseAuth.getInstance().signOut();
                    Intent intent = new Intent(Timer_Menu.this, Add_events_test.class);
                    startActivity(intent);
            ...
            menu_set_timer.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Timer_Menu.this, Input_event_stopwatch.class);
                    startActivity(intent);
                }
            });
